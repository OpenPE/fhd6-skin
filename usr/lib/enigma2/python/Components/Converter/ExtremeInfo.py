 ...
 object):
    ...
    def getBoolean(self):
        ...
        if (self.type == self.IRDECM):
            ...
            caemm = self.getNet()
            return caemm
        elif (self.type == self.BISCRYPT):
            caemm = self.getBisCrypt()
            return caemm
        elif (self.type == self.BISECM):
            caemm = self.getBisEcm()
            return caemm
        elif (self.type == self.MGCAMD):
            caemm = self.getMgcamd()
            return caemm
        elif (self.type == self.OSCAM):
            caemm = self.getOscam()
            return caemm
        elif (self.type == self.CAMD3):
            caemm = self.getCamd3()
            return caemm
        elif (self.type == self.CCAM):
            caemm = self.getCcam()
            return caemm
        elif (self.type == self.MBOX):
            caemm = self.getMbox()
            return caemm
        elif (self.type == self.GBOX):
            caemm = self.getGbox()
            return caemm
        elif (self.type == self.WICARDD):
